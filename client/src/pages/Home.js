      ...
      <Col className="home-description">
        ...
        <Row className="description-item-container">
          <Col className="description-item">
            <p>Find/Search for Recipes</p>
            <img src="https://via.placeholder.com/125 " alt="palceholder" />
            <p>
              Enter an ingredient, dish name or filter your results to find
              receipes.
            </p>
          </Col>
          <Col className="description-item">
            <p>Share what you made</p>
            <img src="https://via.placeholder.com/125 " alt="palceholder" />
            <p>
              You can post the receipes you have tried, and comment on other
              users posts.
            </p>
          </Col>
          <Col className="description-item">
